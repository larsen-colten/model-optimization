...
class Default8BitQuantizeLayoutTransform(
  ...
  def apply(self, model, layer_quantize_map):
    ...
    transforms = [
        default_8bit_transforms.Default8BitInputLayerQuantize(),
        default_8bit_transforms.Conv2DBatchNormReLUQuantize(),
        default_8bit_transforms.Default8BitConv2DBatchNormActivationQuantize(),
        default_8bit_transforms.Default8BitConv2DBatchNormQuantize(),
        default_8bit_transforms.Default8BitConcatTransform6Inputs(),
        default_8bit_transforms.Default8BitConcatTransform5Inputs(),
        default_8bit_transforms.Default8BitConcatTransform4Inputs(),
        default_8bit_transforms.Default8BitConcatTransform3Inputs(),
        default_8bit_transforms.Default8BitConcatTransform(),
    ]
