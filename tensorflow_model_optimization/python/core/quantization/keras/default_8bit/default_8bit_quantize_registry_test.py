...
# ==============================================================================
"""Tests for Default8BitQuantizeRegistry."""
...
class Default8BitQuantizeRegistryTest(tf.test.TestCase, _TestHelper):

  def setUp(self):
    super(Default8BitQuantizeRegistryTest, self).setUp()
    self.quantize_registry = default_8bit_quantize_registry.Default8BitQuantizeRegistry(
    )
