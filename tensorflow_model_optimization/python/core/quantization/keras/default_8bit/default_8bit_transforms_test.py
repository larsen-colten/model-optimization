...
Default8BitConv2DBatchNormActivationQuantize = default_8bit_transforms.Default8BitConv2DBatchNormActivationQuantize
...
class DefaultTransformsTest(tf.test.TestCase, parameterized.TestCase):
  ...
  def testDefault8BitConv2DBatchNormQuantize(self, layer_type):
    ...
    transformed_model, updated_metadata = ModelTransformer(
        model,
        [default_8bit_transforms.Default8BitConv2DBatchNormQuantize()],
    ).transform()
  ...
  @parameterized.parameters(
      ...
      ('Conv2D', 'act_relu', Default8BitConv2DBatchNormActivationQuantize),
      ('DepthwiseConv2D', 'relu', Conv2DBatchNormReLUQuantize),
      ('DepthwiseConv2D', 'act_relu',
       Default8BitConv2DBatchNormActivationQuantize),
  )
  ...
  def testAddsQuantizeLayerAfterInputLayer(self):
    ...
    transformed_model, _ = ModelTransformer(
        model,
        [default_8bit_transforms.Default8BitInputLayerQuantize()]).transform()
  ...
  def testDefault8BitConcatTransform(self):
    ...
    _, updated_metadata = ModelTransformer(
        model, [default_8bit_transforms.Default8BitConcatTransform()],
  ...
  def testConcatMultipleLevels(self):
    ...
    _, layer_metadata = ModelTransformer(
        model,
        [default_8bit_transforms.Default8BitConcatTransform()]).transform()
